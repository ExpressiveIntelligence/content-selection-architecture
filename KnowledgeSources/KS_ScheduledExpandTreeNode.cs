...
namespace CSA.KnowledgeSources
{
    public class KS_ScheduledExpandTreeNode : KS_ScheduledContentPoolCollector
    {
        ...
        protected KS_ScheduledExpandTreeNode(IBlackboard blackboard) : base(blackboard)
        {
            FilterConditionDel = DefaultFilterCondition;
        }

        public KS_ScheduledExpandTreeNode(IBlackboard blackboard, string inputPool) : base(blackboard, inputPool)
        {
        }

        protected KS_ScheduledExpandTreeNode(IBlackboard blackboard, FilterCondition filter) : base(blackboard, filter)
        {
        }
         ...
         */
        protected KS_ScheduledExpandTreeNode(IBlackboard blackboard, string inputPool, FilterCondition filter) : base(blackboard, inputPool, filter)
        {
        }
