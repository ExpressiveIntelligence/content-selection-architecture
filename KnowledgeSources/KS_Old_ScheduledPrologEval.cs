...
namespace CSA.KnowledgeSources
{
    ...
    public class KS_Old_ScheduledPrologEval : KS_Old_ScheduledFilterSelector
    {
        ...
        public KS_Old_ScheduledPrologEval(IBlackboard blackboard) : base(blackboard, DefaultOutputPoolName)
        {
        }

        public KS_Old_ScheduledPrologEval(IBlackboard blackboard, string outputPool) : base(blackboard, outputPool)
        {
        }

        public KS_Old_ScheduledPrologEval(IBlackboard blackboard, string inputPool, string outputPool) : base(blackboard, inputPool, outputPool)
        {
        }

        public KS_Old_ScheduledPrologEval(IBlackboard blackboard, string outputPool, FilterCondition filter) : base(blackboard, outputPool, filter)
        {
        }
    }
}
