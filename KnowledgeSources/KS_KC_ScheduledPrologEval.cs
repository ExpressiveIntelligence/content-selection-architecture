...
namespace CSA.KnowledgeSources
{
    ...
    public class KS_KC_ScheduledPrologEval : KS_KC_ScheduledFilterSelector
    {
        ...
        public KS_KC_ScheduledPrologEval(IBlackboard blackboard, string prologExpName) : 
            base(blackboard, DefaultOutputPoolName, GeneratePrologExpFilter(prologExpName, blackboard))
        {
            PrologExpressionName = prologExpName;
        }

        public KS_KC_ScheduledPrologEval(IBlackboard blackboard, string outputPool, string prologExpName) : 
            base(blackboard, outputPool, GeneratePrologExpFilter(prologExpName, blackboard))
        {
            PrologExpressionName = prologExpName;
        }

        public KS_KC_ScheduledPrologEval(IBlackboard blackboard, string inputPool, string outputPool, string prologExpName) : 
        ...
        public KS_KC_ScheduledPrologEval(IBlackboard blackboard, string outputPool, FilterCondition filter, string prologExpName) : 
