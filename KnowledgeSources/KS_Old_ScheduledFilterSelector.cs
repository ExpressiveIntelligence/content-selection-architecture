...
namespace CSA.KnowledgeSources
{
    ...
    public class KS_Old_ScheduledFilterSelector : ScheduledKnowledgeSource
    {
        ...
        public KS_Old_ScheduledFilterSelector(IBlackboard blackboard, string outputPool) : base(blackboard)
        {
            OutputPool = outputPool;
            FilterConditionDel = DefaultFilterCondition;
        }

        public KS_Old_ScheduledFilterSelector(IBlackboard blackboard, string inputPool, string outputPool) : base(blackboard)
        {
            InputPool = inputPool;
            OutputPool = outputPool;
        ...
        public KS_Old_ScheduledFilterSelector(IBlackboard blackboard, string outputPool, FilterCondition filter) : base(blackboard)
        {
         ...
         */
        public KS_Old_ScheduledFilterSelector(IBlackboard blackboard, string inputPool, string outputPool, FilterCondition filter) : base(blackboard)
        {
            Debug.Assert(filter != null);
